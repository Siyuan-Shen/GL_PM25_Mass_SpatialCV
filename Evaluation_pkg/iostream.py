...
def load_GL_Mask_data(region_name):
    ...
    try:
        ...
        mask_map = dataset['sCityMask']['Mask'].T
        mask_map = mask_map[3000:16000,:]
        lat = np.linspace(-59.995,69.995,13000)
        lon = np.linspace(-179.995,179.995,36000)
    except:
        print('Not in City')
    try:
        dataset = mat.loadmat(Mask_indir+'GBD_Country_Masks_{}_0.01.mat'.format(region_name))
        mask_map = dataset['sCountryMask']['Mask'].T
        mask_map = mask_map[3000:16000,:]
        lat = np.linspace(-59.995,69.995,13000)
        lon = np.linspace(-179.995,179.995,36000)
    except:
    ...
    try:
        dataset = mat.loadmat(Mask_indir+'GBD_Region_Masks_{}_0.01.mat'.format(region_name))
        mask_map = dataset['sRegionMask']['Mask'].T
        mask_map = mask_map[3000:16000,:]
        lat = np.linspace(-59.995,69.995,13000)
        lon = np.linspace(-179.995,179.995,36000)
    except:
