...
def BLOO_AVD_Spatial_CrossValidation(buffer_radius, width, height, sitesnumber, start_YYYY, TrainingDatasets, total_channel_names, main_stream_channel_names, side_stream_channel_names):
    ...
    for iyear in range(len(BLOO_test_beginyears)):
        ...
        AVD_output_text(outfile=txt_outfile,status='a',Area='Global',test_beginyears=BLOO_test_beginyear,test_endyears=BLOO_test_endyear, test_CV_R2=test_CV_R2, train_CV_R2=train_CV_R2, geo_CV_R2=geo_CV_R2, RMSE=RMSE, NRMSE=NRMSE,PMW_NRMSE=PWM_NRMSE,
